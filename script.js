...
document.querySelector(".copy").addEventListener("click", async (f) => {
    let pass = document.querySelector(".result .password");
    await navigator.clipboard.writeText(pass.innerHTML);
});
